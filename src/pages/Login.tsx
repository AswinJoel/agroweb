...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-brand-bg relative overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-4xl w-full px-4 text-center space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div 
            whileHover={{ y: -8 }}
            className="editorial-card group text-left space-y-8 cursor-pointer !p-10 border-2 border-transparent hover:border-brand-secondary/30 transition-all shadow-xl"
          ...
          >
            ...
            <button className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-brand-primary group-hover:text-brand-secondary transition-colors">
              Continue as Farmer <ArrowRight className="size-4" />
            </button>
          </motion.div>
          ...
          <motion.div 
            whileHover={{ y: -8 }}
            className="editorial-card group text-left space-y-8 cursor-pointer !p-10 border-2 border-transparent hover:border-brand-primary/10 transition-all shadow-xl"
          ...
          >
            ...
            <button className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-brand-primary group-hover:text-brand-secondary transition-colors">
              Continue as Customer <ArrowRight className="size-4" />
            </button>
          </motion.div>
        </div>
