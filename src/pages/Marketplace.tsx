...
const DEFAULT_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "Vegetables",
    unit: "kg",
    imageUrl: "https://images.unsplash.com/photo-1449333254714-23eef896346a?auto=format&fit=crop&q=80&w=800",
    farmerId: "f3",
    rating: 4.5,
    reviewsCount: 56
  },
  ...
  },
  {
    ...
    category: "Fruits",
    unit: "dozen",
    imageUrl: "https://images.unsplash.com/photo-1603833665858-e61d17a86224?auto=format&fit=crop&q=80&w=800",
    farmerId: "f4",
    rating: 4.6,
    reviewsCount: 245
  },
  {
    id: "yield-7",
    name: "Farm Fresh Green Beans",
    description: "Freshly harvested, crisp and stringless beans. High in protein and vitamins.",
    price: 85,
    category: "Vegetables",
    unit: "kg",
    imageUrl: "https://images.unsplash.com/photo-1567375639073-20f580234032?auto=format&fit=crop&q=80&w=800",
    farmerId: "f1",
    rating: 4.7,
    reviewsCount: 92
  },
